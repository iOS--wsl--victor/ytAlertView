...
-(void)createBackgroundView
{
    if (!self.tableView) {
        ...
        [_titleLabel setBackgroundColor:[UIColor colorWithRed:241 / 255.0 green:235 / 255.0 blue:230 / 255.0 alpha:1]];
        [self addSubview:_titleLabel];
        
        _bottomBTN = [[UIButton alloc] initWithFrame:CGRectZero];
        [self addSubview:_bottomBTN];
        [_bottomBTN setBackgroundColor:[UIColor colorWithRed:241 / 255.0 green:235 / 255.0 blue:230 / 255.0 alpha:1]];
        ...
        [_bottomBTN drawLineWidth:1.0f color:[UIColor grayColor] startPoint:CGPointMake(0, 1) endPoint:CGPointMake(WIN_WIDTH - 50 * 2, 1)];
        [_titleLabel drawLineWidth:1.0f color:[UIColor grayColor] startPoint:CGPointMake(0, _titleLabel.bounds.size.height) endPoint:CGPointMake(WIN_WIDTH - 50 * 2, _titleLabel.bounds.size.height)];
